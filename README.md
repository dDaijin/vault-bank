Ось відредагована версія вашого README.md, у якій прибрано всі емодзі, а підписи до скріншотів та самі зображення розміщено по центру у сітці (з підписом безпосередньо над відповідною картинкою):
